...
require_once get_template_directory() . '/options/update.php';
...
function hui_postmeta_keywords_description_create() {
    ...
    if ( function_exists('add_meta_box') ) {
        ...
        add_meta_box( 'postmeta_keywords_description_boxes', __('自定义关键字和描述', 'haoui'), 'hui_postmeta_keywords_description', 'page', 'normal', 'high' );
    }
}
