...
<div class="content-wrap">
    ...
    if( _hui('author_link') ){
		...
		<?php if( _hui('ads_post_01_s') && _hui('ads_post_01') ) echo '<div class="ssr ssr-content ssr-post">'.hui_get_adcode('ads_post_01').'</div>'; ?>
		...
		<?php if( _hui('ads_post_02_s') && _hui('ads_post_02') ) echo '<div class="ssr ssr-content ssr-related">'.hui_get_adcode('ads_post_02').'</div>'; ?>
		...
		?>
		<?php if( _hui('ads_post_03_s') && _hui('ads_post_03') ) echo '<div class="ssr ssr-content ssr-comment">'.hui_get_adcode('ads_post_03').'</div>'; ?>
