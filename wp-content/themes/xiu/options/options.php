...
function opshui_options() {
	...
	$options[] = array(
		...
		'std' => '',
		'desc' => __(' 外链缩略图后缀，只有当开启“缩略图使用外链图片”后才有效。说明：如果文章中图片地址是：http://xxxx/xx/aaaa.jpg，该图片的缩略图是：http://xxxx/xx/aaaa-240*180.jpg，那么此处应填写：-240*180，以此类推。', 'haoui').'(v4.1+)',
		'type' => 'text');
