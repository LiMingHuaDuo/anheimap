...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'https://themebetter.com/tm/fuckyou/update';
	
	$db_cache_field = 'xiu-notifier-cache';
	$db_cache_field_last_updated = 'xiu-notifier-last-updated';
