...
if ( !function_exists( 'opshui_add_page' ) ) {
	...
	function opshui_add_page() {
		$hui_page = add_theme_page(__('xiu主题设置', 'haoui'), __('xiu主题设置', 'haoui'), 'edit_theme_options', 'options-ui','opshui_page');
...
function opshui_page() {
    ...
    <div id="opshui-metabox" class="metabox-holder">
		...
		<!--<div class="opshui-sidebar"><div class="opshui-sidebar-widget"><a href="https://themebetter.com" target="_blank"><img src="https://themebetter.com/tm/fuckyou/opad"></a></div></div>-->
	</div>
