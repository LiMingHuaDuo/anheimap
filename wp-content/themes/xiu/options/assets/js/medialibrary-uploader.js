...
/*-----------------------------------------------------------------------------------*/
    ...
    removeFile: function () {
     ...
     $('.mlu_remove').live('click', function(event) { 
        ...
        $(this).parents('.screenshot').siblings('.hui-background-properties').hide(); //remove background properties
        return false;
      });
...
/*-----------------------------------------------------------------------------------*/
/* Replace the default file upload field with a color JWVRn2 customised version.
/*-----------------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------------*/
	...
	window.send_to_editor = function(html) {
		...
		if (formfield) {
		  ...
		  $('#' + formfield).siblings('.hui-background-properties').show(); //show background properties
          tb_remove();
  ...
  }; // End opshuiMLU Object // Don't remove this, or the sky will fall on your head.

/*-----------------------------------------------------------------------------------*/
/* Execute the above methods in the opshuiMLU object.
/*-----------------------------------------------------------------------------------*/
  
	$(document).ready(function () {

		opshuiMLU.removeFile();
		opshuiMLU.recreateFileField();
		opshuiMLU.mediaUpload();
